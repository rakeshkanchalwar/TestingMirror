...
PropertyChangeListener{
	 ...
	 */
	DiagramTreeEditPart(ComponentsDiagram model) {
		super(model);
	}
...
/*		if (getParent() instanceof RootEditPart) {
	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		if (ComponentsDiagram.CHILD_ADDED_PROP.equals(prop)) {
		...
		} else if (ComponentsDiagram.CHILD_REMOVED_PROP.equals(prop)) {
			...
			System.out.println("DiagramTreeEditPart:ComponentEditPart");
			refreshVisuals();
		}
	}
}
