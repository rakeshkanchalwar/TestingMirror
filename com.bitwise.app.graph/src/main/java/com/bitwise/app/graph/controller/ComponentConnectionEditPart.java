...
public class ComponentConnectionEditPart extends AbstractConnectionEditPart implements PropertyChangeListener {
	/**
	...
	public void deactivate() {
		if (isActive()) {
			super.deactivate();
			((ComponentConnection) getModel()).removePropertyChangeListener(this);
		}
	}
	@Override
