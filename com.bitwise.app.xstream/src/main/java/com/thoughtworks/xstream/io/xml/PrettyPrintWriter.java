...
//    	eltLogger.info("PrettyPrintWriter begin startNode(String name, Class clazz)"+name+",  "+clazz);
    	startNode(name);
//    	eltLogger.info("PrettyPrintWriter end startNode(String name, Class clazz)"+name+",  "+clazz);
    }
