...
public class ELTInputCountWidget extends AbstractWidget {
	...
	private static final String InputPort = "Input Count";
	...
	public void attachToPropertySubGroup(AbstractELTContainerWidget container) {
		logger.debug("Starting {} textbox creation", InputPort);
		...
		AbstractELTWidget lable = new ELTDefaultLable(InputPort + " ");
		...
		txtDecorator = WidgetUtility.addDecorator(textBox, Messages.bind(Messages.EMPTY_FIELD, InputPort));
		...
		try {
			...
			logger.error("Failed in attaching listeners to {}", InputPort);
		}
		populateWidget();
		logger.debug("Finished {} textbox creation", InputPort);
	}
	...
	private void populateWidget(){		
		logger.debug("Populating {} textbox", InputPort);
