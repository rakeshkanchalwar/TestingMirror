...
public class TestJar /*implements Opcodes*/ {
	...
	public static void main(String[] args) throws Exception {
		...
		File file = new File(
				"C:/Users/rakeshka/git/master/com.bitwise.app.product/target/products/com.bitwise.app.perspective.ID/win32/win32/x86_64/plugins/com.bitwise.app.model_0.0.1.201509161007.jar");
